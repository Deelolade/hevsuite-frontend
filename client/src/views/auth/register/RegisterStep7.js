            ...
            <div key={index} className="flex items-center">
              <div className="relative">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  index < 7 ? "bg-[#0A5440]" : "bg-white border-2 border-gray-300"
                }`}>
                  {index < 6 ? (
              ...
              {index < 6 && (
                <div className={`w-32 h-[2px] bg-[#0A5440]`} />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="bg-white rounded-lg p-8">
          ...
          <div className="space-y-4">
            {referrals.map((referral) => (
              <div key={referral.id} className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
          ...
          <button className="mt-8 px-6 py-3 bg-gradient-to-r from-[#540A26] to-[#0A5440] text-white rounded-lg inline-flex items-center gap-2">
