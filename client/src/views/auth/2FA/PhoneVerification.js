...
const PhoneVerification = () => {
  ...
  return (
    <div className="min-h-screen md:grid md:grid-cols-2 relative">
      ...
      {/* Phone Verification Form - Centered on mobile, right side on desktop */}
          ...
          <div className="bg-white max-w-md p-8 rounded-xl">
            ...
            <div className="space-y-4">
              <div className="relative flex items-center">
                <BsTelephone className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg" />
                <span className="absolute left-12 text-sm font-primary text-gray-600">
                  +251
                </span>
                <input
                  type="tel"
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg pl-24 text-sm focus:outline-none focus:ring-0 font-primary"
                />
              </div>
