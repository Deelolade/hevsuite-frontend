      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            ...
            <input type="text" defaultValue="5555555" className="w-full p-3 border rounded-lg" />
          </div>
        </div>
  ...
  return (
    <div className="mt-8">
      <div className="flex justify-between items-center">
        <h2 className="text-[#540A26] text-xl font-medium">All Payment Methods</h2>
        <div className="flex gap-2">
          <button onClick={() => setShowAddModal(true)} className="px-6 py-2 bg-[#540A26] text-white rounded-lg">
            Add
          </button>
          <button onClick={() => setShowEditForm(!showEditForm)} className="px-6 py-2 bg-[#540A26] text-white rounded-lg">
            Edit
          </button>
        </div>
      </div>
      ...
      {showEditForm && (
        <div className="space-y-4 mt-8">
          <div>
            <label className="block mb-2">Fullname</label>
            <input type="text" defaultValue="Good Luck" className="w-full p-3 border rounded-lg" />
          </div>
          <div>
            <label className="block mb-2">Card number</label>
            <div className="relative">
          ...
          <button className="w-full bg-[#540A26] text-white rounded-lg p-3">Save</button>
        </div>
      )}
      <AddPaymentModal />
    </div>
    ...
    <div className="mt-8 space-y-8">
      <div className="flex justify-between items-start">
        <div className="max-w-xl">
          ...
          <p className="text-sm text-gray-500 leading-relaxed">
            Deactivating your account is temporary, and it means your profile will be hidden until you reactivate it by logging in.
          </p>
        </div>
        <button
      ...
      <div className="flex justify-between items-start">
        <div className="max-w-xl">
          ...
          <p className="text-sm text-gray-500 leading-relaxed">
            Deleting your account is permanent. When you delete your personal information will permanently deleted if you'd just like to take a break, you can temporarily deactivate your account.
          </p>
        </div>
        <button
