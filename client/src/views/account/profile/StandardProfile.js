    ...
    <div className="text-black">
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setShowRequestModal(true)}>Request</button>
          <button
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handlePersonalInfoChange("relationshipStatus", e.target.value)
                }
                disabled={!isEditing}
                className={`w-full px-3 py-2 ${
                  isEditing ? "bg-white" : "bg-gray-50"
      ...
      <div className="mb-4">
        ...
        >
          ...
          {openSections.contactDetails ? <BsChevronUp /> : <BsChevronDown />}
        </div>
        ...
        {openSections.contactDetails && (
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block mb-1 text-sm">Postcode/Zipcode*</label>
              <input
                type="text"
                value={contactDetails.postcodeZipcode}
                onChange={(e) =>
                  handleContactDetailsChange("postcodeZipcode", e.target.value)
                }
                disabled={!isEditing}
                className={`w-full px-3 py-2 ${
                  isEditing ? "bg-white" : "bg-gray-50"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleContactDetailsChange("secondaryEmail", e.target.value)
                }
                disabled={!isEditing}
                className={`w-full px-3 py-2 ${
                  isEditing ? "bg-white" : "bg-gray-50"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleContactDetailsChange("secondaryPhone", e.target.value)
                }
                disabled={!isEditing}
                className={`w-full px-3 py-2 ${
                  isEditing ? "bg-white" : "bg-gray-50"
        ...
        {openSections.occupation && (
          <div className="mt-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              ...
              <div>
                <label className="block mb-1 text-sm">member of a club?*</label>
                <input
                  type="text"
                  value={occupationInfo.memberOfClub}
                  onChange={(e) =>
                    handleOccupationInfoChange("memberOfClub", e.target.value)
                  }
                  disabled={!isEditing}
                  className={`w-full px-3 py-2 ${
                    isEditing ? "bg-white" : "bg-gray-50"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleOccupationInfoChange("secondaryPhone", e.target.value)
                  }
                  disabled={!isEditing}
                  className={`w-full px-3 py-2 ${
                    isEditing ? "bg-white" : "bg-gray-50"
