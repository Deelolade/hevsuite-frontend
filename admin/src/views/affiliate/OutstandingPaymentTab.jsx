      ...
      <div className="flex justify-end flex-col md:flex-row gap-2 items-center">
        <div className="flex gap-4 relative">
          ...
          <div className="relative">
            ...
            {showFilterDropdown && (
              <div className="absolute z-[100] mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg">
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => handleFilterChange("all")}>
                  All
                </button>
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => handleFilterChange("members")}>
                  Members Only
                </button>
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => handleFilterChange("vip")}>
                  VIP Members
                </button>
              </div>
            )}
          ...
          <div className="relative">
            ...
            {showTimeFilterDropdown && (
              <div className="absolute z-[100] mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => setTimeFilter("all")}>
                  All Events
                </button>
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => setTimeFilter("upcoming")}>
                  Upcoming (7 days)
                </button>
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => setTimeFilter("ongoing")}>
                  Ongoing
                </button>
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => setTimeFilter("completed")}>
                  Completed
                </button>
              </div>
            )}
          ...
          <div className="relative">
            ...
            {showSortDropdown && (
              <div className="absolute z-[100] mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg">
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => handleSortChange("all")}>
                  All
                </button>
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => handleSortChange("latest")}>
                  Latest
                </button>
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={() => handleSortChange("oldest")}>
                  Oldest
                </button>
              </div>
            )}
            ...
            .map((event) => (
              <div key={event._id} className="relative group">
                ...
                <div className="grid grid-cols-1 gap-2 mt-2">
                  <button className="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg text-sm w-full">
...
export default OutstandingPaymentTab