...
const SiteLogos = () => {
  ...
  const [adminLogo, setAdminLogo] = useState(logo);
  const [favIcon, setFavIcon] = useState(logo);
  const [footerIcon, setFooterIcon] = useState(logo);
          ...
          <div className="flex flex-col items-center gap-2">
            <label className="text-primary flex items-center gap-2 cursor-pointer">
              ...
              <input
                ...
                className="hidden"
                accept="image/*"
                onChange={(e) => handleImageSelect(e, setLogo)}
              />
            </label>
          </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          className="px-4 py-2 bg-primary text-white rounded-lg text-sm"
          onClick={() => setIsAdminLogoModalOpen(true)}
        >
          Upload New
        </button>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          className="px-4 py-2 bg-primary text-white rounded-lg text-sm"
          onClick={() => setIsFooterIconModalOpen(true)}
        >
          Upload New
        </button>
      </div>
