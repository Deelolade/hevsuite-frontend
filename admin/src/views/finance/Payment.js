          ...
          >
            <div className="flex items-center gap-8">
              ...
              {processor.isTopPriority && (
                <span className="px-3 py-1 text-sm text-primary border border-primary rounded-full">
                  Top Priority
                </span>
              )}
            </div>
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-dashed border-gray-300 text-center cursor-pointer">
              <button className="text-primary">Click to add image</button>
            </div>
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              />
              <button className="w-full mt-2 p-4 bg-gray-50 rounded-lg border border-dashed border-gray-300 text-center text-primary">
